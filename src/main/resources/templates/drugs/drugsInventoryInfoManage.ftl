...
<div class="row" style="padding-top: 10px;">
    <div class="col-md-2">
        <h1 style="font-size: 24px; margin: 0;" class="">库存列表</h1>
    </div>
    <div class="col-md-10 text-right">
        <a href="##"><span class="glyphicon glyphicon-home"></span> 首页</a> > <a
            disabled="disabled">库存列表</a>
    </div>
</div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover ">
						...
						<tr>
                            ...
                            <td><span>${(item.drugInventoryInfo.inventoryinfoNumber)!''}</span></td>
                            ...
                            <td>
                                <a href="/goDrugsInventoryInfoDetail?inventoryinfoId=${item.drugInventoryInfo.inventoryinfoId}" class="label xiugai">
