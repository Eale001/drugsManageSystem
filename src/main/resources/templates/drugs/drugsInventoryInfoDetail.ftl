...
<div class="row" style="padding-top: 10px;">
    <div class="col-md-2">
        <h1 style="font-size: 24px; margin: 0;" class="">库存详情</h1>
    </div>
    <div class="col-md-10 text-right">
        <a href="##"><span class="glyphicon glyphicon-home"></span> 首页</a> > <a
            disabled="disabled">库存详情</a>
    </div>
</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select class="form-control" name="drugsId" readonly>
                                        <option value="${(inventoryinfo.drugs.drugsId)!''}">${(inventoryinfo.drugs.drugsName)!''}</option>
                                </select>
                            ...
                            <div class="col-md-6 form-group">
                                <label>
                                    <span id="ctl00_cphMain_Label1">库存数量</span>
                                </label>
                            ...
                            <div class="col-md-6 form-group">
                                <label>
                                    <span id="ctl00_cphMain_Label2">第一次录入人员</span>
                                </label>
                                <input name="userId" type="text" value="${(inventoryinfo.userName)!''}"
