...
<div class="row" style="padding-top: 15px;">
    <div class="col-md-12">
        ...
        <div class="bgc-w box">
            ...
            <!--盒子身体-->
            <form action="/saveDrugDeliveryInfo" method="post" onsubmit="return check();">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input name="deliveryinfoNumber" type="text" value="${(drugs.data.deliveryinfoNumber)!''}" class="form-control" readonly/>
